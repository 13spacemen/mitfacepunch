...
/obj/item/weapon/storage
	...
	var/collection_mode = 0;  //0 = pick one at a time, 1 = pick all on tile
	var/foldable = 0	//If set, can be folded (when empty) into a sheet of cardboard
