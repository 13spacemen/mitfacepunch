/obj/item/mecha_parts/mecha_equipment/tool/sleeper
	...
	proc/get_occupant_dam()
		...
		return {"<font color="[occupant.health > 50 ? "blue" : "red"]"><b>Health:</b> [occupant.health]% ([t1])</font><br />
					...
					<font color="[occupant.get_brute_loss() < 60 ? "blue" : "red"]"><b>Brute Damage:</b> [occupant.get_brute_loss()]%</font><br />
					<font color="[occupant.tox_damage < 60 ? "blue" : "red"]"><b>Respiratory Damage:</b> [occupant.oxy_damage]%</font><br />
					<font color="[occupant.tox_damage < 60 ? "blue" : "red"]"><b>Toxin Content:</b> [occupant.tox_damage]%</font><br />
					<font color="[occupant.get_fire_loss() < 60 ? "blue" : "red"]"><b>Burn Severity:</b> [occupant.get_fire_loss()]%</font><br />
					"}
